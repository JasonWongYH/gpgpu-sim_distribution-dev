...
class ptx_thread_info {
 public:
  ...
  ptx_reg_t get_operand_value(const operand_info& op,
                              ...
                              int derefFlag);
  void set_operand_value(const operand_info& dst,
  ...
  void set_operand_value(const operand_info& dst,
                         ...
                         int overflow,
                         int carry);
  void get_vector_operand_values(const operand_info& op,
                                 ptx_reg_t* ptx_regs,
  ...
  void print_insn(unsigned pc, std::ostream& out) const;
  ...
  void callstack_push(unsigned npc,
                      unsigned rpc,
                      const symbol* return_var_src,
                      const symbol* return_var_dst,
                      unsigned call_uid);
  bool callstack_pop();
  void callstack_push_plus(unsigned npc,
                           unsigned rpc,
                           const symbol* return_var_src,
                           const symbol* return_var_dst,
                           unsigned call_uid);
  ...
  void dump_regs(std::ostream& out);
  void dump_modifiedregs(std::ostream& out);
