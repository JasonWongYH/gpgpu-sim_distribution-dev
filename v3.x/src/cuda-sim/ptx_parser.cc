...
void parse_assert_impl(int test_value,
                       const char* file,
                       unsigned line,
                       const char* msg,
                       ...) {
...
void add_constptr(const char* identifier1,
...
void add_4vector_operand(const char* d1,
                         const char* d2,
                         const char* d3,
                         const char* d4) {
...
void func_header_info_int(const char* a, int b) {}  // intentional dummy
                                                    // function
