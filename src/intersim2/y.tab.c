...
/* Put the tokens into the symbol table, so that GDB and other debuggers
   know about them.  */
enum yytokentype { STR = 258, NUM = 259, FNUM = 260 };
#endif
/* Tokens.  */
#define STR 258
#define NUM 259
...
static const yytype_uint8 yytranslate[] = {
    ...
    2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 7, 2, 6, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2,
    2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2,
    2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2,
    2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2,
    2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2,
...
/* YYPRHS[YYN] -- Index of the first RHS symbol of rule number YYN in
   YYRHS.  */
static const yytype_uint8 yyprhs[] = {0, 0, 3, 6, 8, 13, 18};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] = {9,  0, -1, 9, 10, -1, 10, -1, 3, 6, 3, 7,
                                    -1, 3, 6,  4, 7,  -1, 3,  6,  5, 7, -1};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint8 yyrline[] = {0, 28, 28, 29, 32, 33, 34};
#endif
...
/* YYTOKNUM[YYLEX-NUM] -- Internal token number corresponding to
   token YYLEX-NUM.  */
static const yytype_uint16 yytoknum[] = {0, 256, 257, 258, 259, 260, 61, 59};
#endif

/* YYR1[YYN] -- Symbol number of symbol that rule YYN derives.  */
static const yytype_uint8 yyr1[] = {0, 8, 9, 9, 10, 10, 10};

/* YYR2[YYN] -- Number of symbols composing right hand side of rule YYN.  */
static const yytype_uint8 yyr2[] = {0, 2, 2, 1, 4, 4, 4};

/* YYDEFACT[STATE-NAME] -- Default reduction number in state STATE-NUM.
   Performed when YYTABLE doesn't specify something else to do.  Zero
   means the default is an error.  */
static const yytype_uint8 yydefact[] = {0, 0, 0, 3, 0, 1, 2, 0, 0, 0, 4, 5, 6};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] = {-1, 2, 3};

/* YYPACT[STATE-NUM] -- Index in YYTABLE of the portion describing
   STATE-NUM.  */
#define YYPACT_NINF -5
static const yytype_int8 yypact[] = {-2, -4, 0, -5, 1,  -5, -5,
                                     2,  3,  4, -5, -5, -5};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] = {-5, -5, 5};

/* YYTABLE[YYPACT[STATE-NUM]].  What to do in state STATE-NUM.  If
   positive, shift that token.  If negative, reduce the rule which
   number is the opposite.  If YYTABLE_NINF, syntax error.  */
#define YYTABLE_NINF -1
static const yytype_uint8 yytable[] = {5, 1, 4, 1, 7, 8, 9, 6, 0, 10, 11, 12};

#define yypact_value_is_default(yystate) ((yystate) == (-5))

#define yytable_value_is_error(yytable_value) YYID(0)

static const yytype_int8 yycheck[] = {0, 3, 6, 3, 3, 4, 5, 2, -1, 7, 7, 7};

/* YYSTOS[STATE-NUM] -- The (internal number of the) accessing
   symbol of state STATE-NUM.  */
static const yytype_uint8 yystos[] = {0, 3, 9, 10, 6, 0, 10, 3, 4, 5, 7, 7, 7};
...
#line 32 "config.y"
    {
      config_assign_string((yyvsp[(1) - (4)].name), (yyvsp[(3) - (4)].name));
      free((yyvsp[(1) - (4)].name));
      free((yyvsp[(3) - (4)].name));
    } break;
...
#line 33 "config.y"
    {
      config_assign_int((yyvsp[(1) - (4)].name), (yyvsp[(3) - (4)].num));
      free((yyvsp[(1) - (4)].name));
    } break;
...
#line 34 "config.y"
    {
      config_assign_float((yyvsp[(1) - (4)].name), (yyvsp[(3) - (4)].fnum));
      free((yyvsp[(1) - (4)].name));
    } break;
